...
Der Anspruch aus der Aufgabenstellung, viele hundert quelloffene Lösungen einzubinden, ist unter diesen Bedingungen erreichbar. Der Anspruch, eine vierstellige Zahl einzubinden **und** für jeden Eintrag eine Pflegezusage zu geben, ist es nur im Beharrungszustand, mit einem T2-Anteil unter sechs Prozent und mit externen Pflegestellen für einen erheblichen Teil des Bestands.
...
| RS-15 | Unterstützungszeitraum nicht einhaltbar | Fünf gleichzeitige Linien binden 26,1 Personentage jährlich allein für Rückportierung | Zusage muss gebrochen werden; das ist der teuerste aller Vertrauensschäden | mittel | Zeitraum erst mit nachgewiesener Finanzierung festlegen; Zahl der Linien in der Konsole sichtbar | Rückportierungsrückstand über zwei Freigabezyklen |
