...
| `healthcheck` | 1.000 ms | Läuft alle 300 s über alle Bindungen; bei 160 Bindungen (K-20-Annahme: 20 Mandanten × 8 aktive Bindungen) sind 160 s Arbeit und damit innerhalb des Intervalls. Annahme Großinstallation 3.000 Bindungen: 3.000 s Arbeit, die auf verteilte Verwaltungsknoten zu legen ist |
