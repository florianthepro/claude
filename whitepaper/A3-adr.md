...
**Begründung:** Ein kompromittierter Mandant darf unter keiner Stufe für fremde Namen ausstellen können; die Namensbeschränkung der Zwischen-CA ist die einzige Stelle, an der das technisch und nicht organisatorisch durchsetzbar ist. Rechnung zur Schadensbegrenzung mit den Annahmen aus K-12: rund 1.450 Endzertifikate je Installation; ohne Zwischen-CA betrifft eine Kompromittierung alle 1.450, mit Zwischen-CA je Mandant bei 20 Mandanten im Mittel 1.450 / 20 = 72,5.
...
**Begründung:** Eine Regel, die nicht aus einem Objekt folgt, ist per Invariante nicht existent. Modellrechnung des Umfangs mit den Annahmen aus K-12: 500 Veröffentlichungen ergeben 500 Eingangsregeln, 40 Netzzonen je eine Grundregel, 160 Konnektorbindungen mit je 3 Zieladressen 480 Ausgangsregeln, zusammen 500 + 40 + 480 = 1.020 Regeln. Bei angenommen 20 Änderungen je Woche, 3 betroffenen Regeln je Änderung und 4 Minuten Handarbeit je Regel wären das 20 × 3 × 4 = 240 Minuten je Woche, also 208 Stunden oder rund 26 Personentage je Jahr allein für Regelpflege. Das ist ein Modell, keine Messung.
