...
Nach einer Unterbrechung von 29 d stehen 35,4 /d · 29 = 1.027 Erneuerungen gleichzeitig an. Bei der Bedienrate von 200 Konsensschreibvorgängen je Sekunde aus [Kapitel 08](08-kontrollebene.md) dauert der Nachlauf 1.027 / 200 = 5,1 s. Der Rückstau ist also kein Problem der CA, sondern eines der Gleichzeitigkeit: damit nicht alle Clients zur selben Minute anfragen, leitet jeder Erneuerungsversuch seinen Zeitversatz innerhalb der Stunde deterministisch aus der Seriennummer ab.
...
| R-11-15 | EST bietet keine serverseitige Schlüsselerzeugung; das Registriergeheimnis ist einmalig, ≤ 24 h gültig und nach 5 Fehlversuchen vernichtet. | RFC 7030, INV-20 |
...
| Ein EST-Aufruf auf serverseitige Schlüsselerzeugung wird abgelehnt; ein zweites Mal verwendetes Registriergeheimnis erzeugt 0 Zertifikate | R-11-15 | Wiederverwendungs- und Ratentest |
