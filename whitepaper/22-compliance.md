...
**Rechnung Prüfaufwand je Freigabe:** 20 Standardaufgaben nach K-26, je Aufgabe ein Tastaturdurchlauf und ein Bildschirmleserdurchlauf, Annahme 15 Minuten je Durchlauf. Das ergibt 20 × 2 × 0,25 h = 10 Stunden je Freigabe. Bei angenommen 6 Freigaben jährlich sind das 60 Stunden oder 7,5 Personentage. **Deutung:** Der Aufwand ist tragbar, solange die Zahl der Standardaufgaben begrenzt bleibt; jede zusätzliche Standardaufgabe kostet dauerhaft 0,5 Stunden je Freigabe und ist damit ein Argument für die Begrenzung des Aufgabenkatalogs, nicht nur für die Bedienbarkeit.
...
- **R-22-27** — Die Atrium Console erfüllt WCAG 2.2 Stufe AA; die automatisierte Regelprüfung meldet 0 Verstöße, und der Tastaturdurchlauf aller Standardaufgaben ist ohne Zeigegerät vollständig durchführbar. Prüfbar: beide Verfahren im Bau; ein Verstoß bricht den Bau (INV-31, K-27).
...
| R-22-27 | 0 Verstöße in der automatisierten Regelprüfung, alle 20 Standardaufgaben ohne Zeigegerät durchführbar | Regelprüfung und Tastaturdurchlauf im Bau |
